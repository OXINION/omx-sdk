...
async function main() {
    ...
    try {
        ...
        const [triggerResult, emailResult, webhookResult, healthResult] = await Promise.allSettled([
            testGeotrigger(sdk),
            testEmail(sdk),
            testWebhook(sdk),
            testSDKHealth(sdk),
        ...
        console.log('🌍 Geotrigger:', triggerResult.status === 'fulfilled' ? 'PASSED' : 'FAILED');
        console.log('📧 Email:', emailResult.status === 'fulfilled' ? 'PASSED' : 'FAILED');
        console.log('🔗 Webhook:', webhookResult.status === 'fulfilled' ? 'PASSED' : 'FAILED');
        console.log('🔍 Health Check:', healthResult.status === 'fulfilled' ? 'PASSED' : 'FAILED');
...
//# sourceMappingURL=test-omx-integration.js.map